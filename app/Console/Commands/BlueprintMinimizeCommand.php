...
class BlueprintMinimizeCommand extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'blueprint:minimize {fileKey} {nodeId}';
    ...
    public function handle()
    {
        ...
        $url = "https://api.figma.com/v1/files/{$fileId}/nodes?ids={$encodedNodeId}";
        ...
        if ($response->successful()) {
            ...
            $this->error("Failed to fetch data from Figma API. Status: {$response->status()}");
